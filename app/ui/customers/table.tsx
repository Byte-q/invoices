      ...
      <div className="mt-6 flow-root">
        <div className="overflow-x-auto">
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden rounded-md bg-card shadow-sm border p-2 md:pt-0">
              ...
              <table className="hidden min-w-full rounded-md md:table">
                <thead className="rounded-md border-b text-left text-sm font-normal">
                  <tr>
                    ...
                    <th scope="col" className="px-4 py-5 text-center font-medium">
                      Edit
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="">
                  {customers.map((customer) => (
                    <tr key={customer.id} className="group border-b last-of-type:border-none">
