        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              id="customer"
              name="customerId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 dark:border-neutral-400 dark:bg-gray-800 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
